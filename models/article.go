...
type Article struct {
	Category   string    `orm:"column(category);size(100);null" description:"分类" json:"category"`
	Content    string    `orm:"column(content);null" description:"文章内容" json:"content"`
	CreateTime time.Time `orm:"column(create_time);type(datetime);null" description:"发布时间" json:"create_time"`
	Id         int       `orm:"column(id);pk" json:"id"`
	Status     string    `orm:"column(status);null" description:"文章状态(DRAFT: 草稿， PUBLISHED: 发布，OFFLINE: 下线)" json:"status"`
	Tag        string    `orm:"column(tag);size(100);null" description:"标签" json:"tag"`
	Title      string    `orm:"column(title);size(200);null" description:"标题" json:"title"`
}
